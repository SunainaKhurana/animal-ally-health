...
const HealthReportsPage = () => {
  ...
  const { healthReports, loading, refetch, addReportToState } = useHealthReports(petId);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-4xl mx-auto px-6 py-6">
          ...
          {/* Action Button - Only show if we have reports */}
          {hasAnyReports && (
      ...
      <div className="max-w-4xl mx-auto px-6 py-8 space-y-8">
        {/* Upload Component - Show if user clicked upload or no reports exist */}
        ...
        {/* Only show filters and reports if we have reports */}
        {hasAnyReports && (
          <>
            {/* Filters */}
